...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | Sft  | GUI  |  App |PrtSc |ESC/  |Space/|Space |   |Space | KANA | META |=>GAME|=>SYMB|   _  |  \   |
   * |      |      |      |      |~SYMB |Cmd   |      |   |      |      |      |      |      |      |      |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [BASE] = LAYOUT( \
    ...
    KC_LCTRL, KC_Z,    KC_X,   KC_C,    KC_V,             KC_B,          S(KC_RBRC), S(KC_BSLS), KC_N, KC_M, KC_COMM,   KC_DOT,   KC_SLSH,      KC_ENT, \
    KC_LSFT,  KC_LGUI, KC_APP, KC_PSCR, LT(SYMB, KC_ESC), GUI_T(KC_SPC), KC_SPC,     KC_SPC,     KANA, META, TG(_GAME), TG(SYMB), SFT_T(KC_RO), KC_JYEN \
  ),
   ...
   * |   1  |   2  |   3  |   4  |   5  |   6  |  [   |   |  ]   |   7  |   8  |   9  |   0  |   -  |  ^   |
   * |------+------+------+------+------+------+------|   |-------------+------+------+------+------+------|
   * | Tab  |  F1  |      |Muhen | Henk |      |  (   |   |  )   | Left | Down |  Up  |Right |      |      |
   * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
   * | Ctrl |  F2  |  F3  |  F4  |  F5  |  F6  |  {   |   |  }   |  F7  |  F8  |  F9  | F10  | F11  |\/Sft |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | Sft  | GUI  |  App |PrtSc |ESC/  |Space/|Tab/  |   |Back  |Enter/| KANA |Reset |=>GAME|=>SYMB|  \   |
   ...
   * | Ctrl |      |      |      |      |      |  {   |   |  }   |      |      |   <  |   >  |   ?  |  \   |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | Sft  | GUI  |  App |PrtSc |ESC/  |Space/|Tab/  |   |Back  |Enter/| KANA |PrtSc |=>GAME|=>SYMB|  \   |
   * |      |      |      |      |~SYMB |Ctrl  |Shift |   |Space |~META |      |      |      |      |      |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [SYMB] = LAYOUT( \
