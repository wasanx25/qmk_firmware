...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_JYEN, KC_UP,  KC_RO,   \
    KC_GRV,    KC_LALT,   KC_LGUI, KC_LANG2,    KC_SPC,        KC_SPC, KC_LANG1,  KC_LANG1,               KC_LEFT, KC_DOWN, KC_RGHT \
  ),
  [1] = LAYOUT( \
